...
const RULES = [
  ...
  { area: "frontend.runtime", pattern: /^src\/ts\/startup_error_logging\.ts$/ },
  ...
  { area: "frontend.ui", pattern: /^src\/ts\/review_comments\.ts$/ },
  ...
  { area: "frontend.platform", pattern: /^src\/ts\/platform\/.*\.ts$/ },
  ...
  { area: "frontend.domain", pattern: /^src\/ts\/replay_share\.ts$/ },
  { area: "frontend.domain", pattern: /^src\/ts\/replay_deep_link\.ts$/ },
  { area: "frontend.domain", pattern: /^src\/ts\/community_comments\.ts$/ },
  { area: "frontend.domain", pattern: /^src\/ts\/community_identity\.ts$/ },
  { area: "frontend.domain", pattern: /^src\/ts\/youtube_upload_defaults\.ts$/ },
  { area: "frontend.domain", pattern: /^src\/ts\/youtube_upload_history\.ts$/ },
  ...
  { area: "frontend.i18n", pattern: /^src\/ts\/ui_locale\.ts$/ },
