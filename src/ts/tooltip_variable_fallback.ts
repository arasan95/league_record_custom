// AUTO-GENERATED: Language-independent tooltip variable fallbacks
// Extracted from WAD spelldata to resolve '?' in DDragon tooltip variables across all languages.
export const tooltipVariableFallback: Record<string, Record<string, string>> = {
    "AkshanW": {
