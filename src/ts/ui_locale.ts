...
const STATIC_TEXT: Record<string, { ja: string; en: string }> = {
    ...
    sharingSettings: { ja: "共有設定", en: "Sharing Settings" },
    displayOptions: { ja: "表示オプション", en: "Display Options" },
    ...
    rankVerifiedUsers: { ja: "LoLランク連携済みユーザー", en: "LoL rank-linked users" },
    everyone: { ja: "全員", en: "Everyone" },
    saveSettings: { ja: "設定を保存", en: "Save Settings" },
    createInvite: { ja: "招待リンクを発行・コピー", en: "Create & Copy Invite Link" },
    copyAppInviteLink: { ja: "リンクをもう一度コピー", en: "Copy Link Again" },
    issuedInvite: { ja: "発行した招待リンク", en: "Issued invite link" },
    inviteCode: { ja: "招待コード", en: "Invite code" },
    join: { ja: "参加", en: "Join" },
    displayGroup: { ja: "表示グループ", en: "Display Group" },
    displayUsers: { ja: "表示ユーザー", en: "Display Users" },
    allUsers: { ja: "すべてのユーザー", en: "All Users" },
    ...
    anonymousComment: { ja: "匿名で投稿", en: "Post anonymously" },
