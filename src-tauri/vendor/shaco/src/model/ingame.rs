...
pub(crate) fn treat_error_as_none<'de, D, T: DeserializeOwned>(deserializer: D) -> Result<Option<T>, D::Error>
where
    D: Deserializer<'de>,
{
    #[derive(Deserialize)]
...
impl GameEvent {
    pub fn get_event_id(&self) -> EventId {
        match self {
            ...
            GameEvent::ItemPurchased(e) => e.event_id,
            GameEvent::ItemSold(e) => e.event_id,
            GameEvent::ItemUndo(e) => e.event_id,
    ...
    pub fn get_event_time(&self) -> Time {
        match self {
            ...
            GameEvent::ItemPurchased(e) => e.event_time,
            GameEvent::ItemSold(e) => e.event_time,
            GameEvent::ItemUndo(e) => e.event_time,
...
pub struct ItemUndo {
    ...
    pub event_id: EventId,
    pub event_time: Time,
    pub item_after: PlayerItem,
    pub item_before: PlayerItem,
    pub gold_gain: Gold,
    pub shopper_name: SummonerName,
}
